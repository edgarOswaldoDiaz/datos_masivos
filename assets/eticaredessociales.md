#### Consideraciones éticas sobre el análisis de redes sociales

El **análisis de redes sociales (Social Network Analysis, SNA)** estudia las relaciones, interacciones y estructuras sociales a partir de datos vinculados a individuos, grupos u organizaciones. Aunque ofrece un enorme valor para comprender dinámicas sociales, difusión de información, influencia o comportamiento colectivo, su aplicación plantea **importantes dilemas éticos** que deben ser considerados de forma rigurosa en contextos académicos, empresariales y gubernamentales.
...
*   Aunque los datos provengan de plataformas públicas (por ejemplo, Twitter/X, foros o repositorios abiertos), **la agregación y análisis relacional puede revelar información sensible** que no era evidente en los datos originales.
*   En SNA no solo se analizan atributos individuales, sino **patrones de relación**, lo que puede exponer:
    *   Afiliaciones políticas, religiosas o ideológicas
...
*   En redes grandes, es inviable obtener el consentimiento explícito de todos los nodos.
*   Muchas veces, los datos se recolectan de plataformas digitales sin interacción directa con los usuarios.
*   Una persona puede aparecer en una red **sin haber generado datos directamente**, por ejemplo, al ser mencionada o etiquetada por otros.
...
*   Estigmatización de individuos o grupos identificados como “centrales”, “aislados” o “problemáticos”.
*   Vigilancia indebida o persecución en contextos políticos, laborales o sociales.
*   Malinterpretación de relaciones (correlación vs. causalidad), que puede llevar a decisiones injustas.

Ejemplos de riesgo:

*   Uso de análisis de redes para monitorear activismo social o disidencia política.
...
*   ¿Quién se beneficia del conocimiento generado?
*   ¿Podría el mismo análisis ser utilizado con fines coercitivos, discriminatorios o manipulativos?

En contextos de Big Data:
...
*   Existen sesgos por acceso tecnológico, idioma, cultura o plataforma.
*   Algunos grupos pueden estar subrepresentados o ser invisibles en la red analizada.
*   Los algoritmos de detección de comunidades, influencia o difusión pueden amplificar desigualdades existentes.
...
*   **Transparente:** explicar qué datos se usaron, cómo se construyó la red y qué métricas se aplicaron.
*   **Explicable:** comunicar resultados de forma comprensible para audiencias no técnicas.
*   **Auditables:** permitir revisión metodológica y cuestionamiento de supuestos.
...
*   Legislación de protección de datos (como principios de minimización, proporcionalidad y seguridad).
*   Códigos de ética profesional y académica.
*   Lineamientos institucionales de investigación responsable.
