...
​El análisis de sentimientos se refiere a la tarea de determinar la actitud emocional expresada en un texto, ya sea positiva, negativa o neutral. En el contexto de Twitter, esto puede aplicarse para comprender cómo se sienten las personas sobre un tema específico, un producto, un
evento o incluso una marca.
